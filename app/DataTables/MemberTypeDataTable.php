...
class MemberTypeDataTable extends DataTable
{
    /**
     ...
     */
    public function query(MemberType $model): QueryBuilder
    {
    ...
    {
        return 'MemberType_' . date('YmdHis');
    }
}
