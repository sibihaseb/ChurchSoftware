...
class FamilyMemberTypeDataTable extends DataTable
{
    /**
     ...
     */
    public function query(FamilyMemberType $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('familymembertype-table')
    ...
    {
        return 'FamilyMemberType_' . date('YmdHis');
    }
}
