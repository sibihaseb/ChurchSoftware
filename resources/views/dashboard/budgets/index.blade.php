                ...
                <div class="card custom-card">
                    ...
                    <div class="card-header justify-content-between">
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-2">
                            ...
                            <form id="delete_form" action="{{ route('common.deleteSelected', 'Budgets') }}" class="mb-0"
                                method="POST">
                                @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $('#budgets-table').on('change', '.row-select', function() {
            let id = $(this).val();
            if (this.checked) {
                selectedIds.add(id);
            } else {
        ...
        $(document).ready(function() {
            ...
            $('#ok_btn').on('click', function() {
                var currentPage = window.LaravelDataTables["budgets-table"].page.info().page + 1;
            ...
            $('#budgets-table').on('init.dt', function() {
                // Get the DataTable instance once initialized
                var table = window.LaravelDataTables["budgets-table"];
                ...
                if (table) {
                    ...
                    console.error("DataTable 'budgets-table' is not initialized.");
                }
            });
        });
