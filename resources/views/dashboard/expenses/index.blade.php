                    ...
                    <div class="card-header justify-content-between">
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-2">
                            <a href="{{ route('expenses.create') }}"
                                    ...
                                    <form id="delete_form" action="{{ route('common.deleteSelected', 'Expenses') }}" class="mb-0"
                                method="POST">
                                @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $('#expenses-table').on('change', '.row-select', function() {
            let id = $(this).val();
            if (this.checked) {
                selectedIds.add(id);
            } else {
        ...
        $(document).ready(function() {
            ...
            $('#ok_btn').on('click', function() {
                var currentPage = window.LaravelDataTables["expenses-table"].page.info().page + 1;
            ...
            $('#expenses-table').on('init.dt', function() {
                ...
                if (table) {
                    ...
                    console.error("DataTable 'expenses-table' is not initialized.");
                }
            });
        });
