    ...
    <div class="container-fluid">
        <nav class="py-4">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ url('admin/expenses') }}">{{ __('Expenses') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">
                    {{ isset($data) ? __('Update') : __('Create') }} {{ __('Expenses') }}
                </li>
            </ol>
        </nav>
                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
                            @if (Route::currentRouteNamed('expenses.create'))
                                {{ __('Create Expenses') }}
                            @else
                                {{ __('Update Expenses') }}
                            @endif
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST"
                            action="{{ isset($data) ? route('expenses.update', $data->id) : route('expenses.store') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="row">
                                        ...
                                        <!-- Expenses Types Multi-Select -->
                                        <div class="col-lg-6">
                                            <label class="control-label">{{ __('Expenses Types') }} <span style="color: red;">*</span></label>
