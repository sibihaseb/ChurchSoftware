...
@section('scripts')
    ...
    <script>
        ...
        $('#expensestypes-table').on('change', '.row-select', function() {
            let id = $(this).val();
            if (this.checked) {
                selectedIds.add(id);
            } else {
        ...
        $(document).ready(function() {
            ...
            $('#ok_btn').on('click', function() {
                var currentPage = window.LaravelDataTables["expensestypes-table"].page.info().page + 1;
            ...
            $('#expensestypes-table').on('init.dt', function() {
                // Get the DataTable instance once initialized
                var table = window.LaravelDataTables["expensestypes-table"];
                ...
                if (table) {
                    ...
                    console.error("DataTable 'expensestypes-table' is not initialized.");
                }
            });
        });
