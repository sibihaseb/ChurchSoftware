    ...
    <div class="container-fluid">
        ...
        <nav class="py-4">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('BudgetTypes') }}</li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-xl-12">
...
@section('scripts')
    ...
    <script>
        ...
        $('#budgettypes-table').on('change', '.row-select', function() {
            let id = $(this).val();
            if (this.checked) {
                selectedIds.add(id);
            } else {
        ...
        $(document).ready(function() {
            ...
            $('#ok_btn').on('click', function() {
                var currentPage = window.LaravelDataTables["budgettypes-table"].page.info().page + 1;
            ...
            $('#budgettypes-table').on('init.dt', function() {
                // Get the DataTable instance once initialized
                var table = window.LaravelDataTables["budgettypes-table"];
                ...
                if (table) {
                    ...
                    console.error("DataTable 'budgettypes-table' is not initialized.");
                }
            });
        });
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == 'Add') {
                    action_url = "{{ route('budget_types.store') }}";
                    $.ajax({
                        url: action_url,
                        method: "POST",
                        data: formdata,
                ...
                if ($('#action').val() == 'Edit') {
                    ...
                    action_url = "{{ url('admin/budget_types') }}" + "/" + dataId;
